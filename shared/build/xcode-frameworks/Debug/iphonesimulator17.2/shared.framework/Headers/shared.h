...
@class SharedArticle, SharedArticlesState, SharedBaseViewModel, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException;

@protocol SharedKotlinx_coroutines_coreCoroutineScope, SharedKotlinx_coroutines_coreStateFlow, SharedKotlinCoroutineContext, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreFlow, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKotlinIterator;
